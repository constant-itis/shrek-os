...
QtObject {
    // Bounded shell layout contract. Defaults intentionally preserve the current Shrek layout, but
    // surfaces/widgets should consume these roles instead of assuming a permanent left rail.
    readonly property string panelEdge: "left"        // left | right | top | bottom
